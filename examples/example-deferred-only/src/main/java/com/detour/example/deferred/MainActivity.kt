...
import com.detour.example.deferred.databinding.ActivityMainBinding
...
/**
 * Deferred-only example: calls [Detour.getDeferredLink] directly without [com.detour.sdk.DetourDelegate].
 *
 ...
 * - No [com.detour.sdk.DetourDelegate] — no [onNewIntent] wiring needed.
